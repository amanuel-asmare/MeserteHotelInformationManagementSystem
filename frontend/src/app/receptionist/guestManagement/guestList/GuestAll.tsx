...
// import AddGuestModal from '../modals/AddGuestModal'; // Commented out in original
...
export default function GuestList() {
  ...
  const columns: GridColDef[] = [
    ...
    { field: 'email', headerName: t('emailAddress').toUpperCase(), width: 250 },
  ...
  return (
    <div className="p-4 md:p-6 space-y-6 md:space-y-8 min-h-screen bg-gradient-to-br from-amber-50/50 via-white to-amber-50/30 dark:from-gray-900 dark:to-gray-800">
      ...
      {/* Modals */}
      <AnimatePresence>
        {selected && <GuestProfileModal guest={selected as any} onClose={() => setSelected(null)} />}
      </AnimatePresence>
