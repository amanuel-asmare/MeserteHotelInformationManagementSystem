// src/app/manager/settings/ManagerSettingsClient.tsx
'use client';

import { useState } from 'react';
import { useAuth } from '../../../../context/AuthContext';
import { motion, AnimatePresence } from 'framer-motion';
import { CheckCircle, Upload, Lock, User, Mail, LogOut, Camera, Eye, EyeOff,ArrowLeft } from 'lucide-react';
      ...
      >
        ...
        <div className="w-12 h-12 bg-gradient-to-br from-amber-600 to-orange-600 rounded-xl flex items-center justify-center text-white shadow-lg">
          ...
          <div>
            ...
            <p className="text-gray-600">Update your profile and security</p>
          </div>
        </div>
