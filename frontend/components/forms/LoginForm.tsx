...
export default function LoginForm({ onClose, onSwitch, onSwitchToRegister }: LoginFormProps) {
  ...
  return (
    <Modal title="" onClose={onClose}>
      ...
      <div className="max-w-md w-full mx-auto overflow-hidden rounded-3xl bg-white dark:bg-gray-900 shadow-xl min-h-[500px] max-h-[90vh] overflow-y-auto custom-scrollbar mt-45">
