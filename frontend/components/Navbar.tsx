...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="fixed top-0 bottom-0 left-0 right-0 z-[60] bg-black/80 backdrop-blur-xl border-b border-amber-600/20 shadow-2xl transition-all duration-300 mb-20">
