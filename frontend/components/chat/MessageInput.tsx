...
interface MessageInputProps {
    onSendMessage: (message: { text: string; file: File | null; replyTo: string | null }) => void;
    replyingTo: any; // Ideally this should be the Message type, but 'any' works for now if not imported
    onCancelReply: () => void;
}
...
const MessageInput = ({ onSendMessage, replyingTo, onCancelReply }: MessageInputProps) => {
    ...
    return (
        <div className="p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shrink-0 z-20">
            {/* Replying To Preview */}
            <AnimatePresence>
                {replyingTo && (
                    <motion.div
                    ...
                    >
                        ...
                        <div className="flex-1">
                            <p className="font-bold text-amber-600">{replyingTo.sender?.firstName || "Unknown"}</p>
